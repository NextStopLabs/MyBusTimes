...
urlpatterns = [
    ...
    path('create/livery/request-edit/', request_livery_edit_list, name='request_livery_edit_list'),
    path('create/livery/request-edit/<int:livery_id>/', request_livery_edit, name='request_livery_edit'),
