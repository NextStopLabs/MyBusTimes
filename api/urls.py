...
urlpatterns = [
    ...
    path("routes/timetable-trips/", ratelimit(key='ip', method='GET', rate='10/s')(get_routes_timetable_trips), name="routes-timetable-trips-api"),
    ...
    path("operator/<str:operator_slug>/create-duty/", ratelimit(key='ip', method='POST', rate='10r/s')(create_duty_from_timetable_api), name="create-duty-api"),
