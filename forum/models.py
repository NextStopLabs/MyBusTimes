...
class Thread(models.Model):
    ...
    message_limit = models.IntegerField(default=5000, help_text="0 for no limit else maximum number of messages allowed in this thread before it deletes the oldest messages")
