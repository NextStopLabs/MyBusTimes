...
class Tracking(models.Model):
    ...
    tracking_data = models.JSONField(default=default_tracking_data, db_index=True)
    tracking_history_data = models.JSONField(default=default_tracking_history, db_index=True)
