...
urlpatterns = [
    ...
    path('<str:operator_slug>/depots/', depots, name='operator-depots'),
    path('<str:operator_slug>/depots/add/', depot_add, name='add-depot'),
    path('<str:operator_slug>/depots/edit/<int:depot_id>/', depot_edit, name='edit-depot'),
    path('<str:operator_slug>/depots/delete/<int:depot_id>/', depot_delete, name='delete-depot'),
    # Tickets
    ...
    # Running boards
    path('<str:operator_slug>/blocks/', blocks, name='operator_blocks'),
    path('<str:operator_slug>/blocks/<int:board_id>/', block_detail, name='operator_block_detail'),
    path('<str:operator_slug>/blocks/<int:board_id>/vehicle/<int:vehicle_id>/', block_detail, name='operator_block_detail'),
    path('<str:operator_slug>/running-boards/', duties, name='operator-running-boards'),
    path('<str:operator_slug>/running-boards/add/', duty_add, name='add-running-board'),
    path('<str:operator_slug>/running-boards/add/trips/<int:duty_id>/', duty_add_trip, name='add-running-board-trips'),
    path('<str:operator_slug>/running-boards/delete/<int:duty_id>/', duty_delete, name='delete-running-board'),
    path('<str:operator_slug>/running-boards/edit/<int:duty_id>/', duty_edit, name='edit-running-board'),
    path('<str:operator_slug>/running-boards/edit/<int:duty_id>/trips/', duty_edit_trips, name='edit-running-board-trips'),
    path('<str:operator_slug>/running-boards/<int:duty_id>/', duty_detail, name='running-board-detail'),
